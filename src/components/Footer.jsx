...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaGithub />, href: "https://github.com/yourusername", color: "#fff" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-white text-black py-3 px-6 rounded-lg font-bold text-center text-xs uppercase tracking-widest hover:bg-[#66d9ed] transition-all"
            >
          ...
          <div className="flex gap-6">
            {socialLinks.map((link, i) => (
              <motion.a
                ...
                className="text-gray-500 text-xl transition-colors"
              >
                {link.icon}
              </motion.a>
            ))}
